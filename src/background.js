...
// Helper function to check if image needs resizing based on dimensions
async function needsResizing(imageUrl, targetWidth, targetHeight) {
    return new Promise((resolve) => {
        const img = new Image();
        img.onload = function() {
            const needsResize = this.naturalWidth > targetWidth || this.naturalHeight > targetHeight;
            resolve(needsResize);
        };
